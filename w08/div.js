...
function changePicture(index){
    ...
    switch (index){
        case 1:
            pic.innerHTML = '<img src="./images/TKU1.png" style="width: 100%; height: auto" />'
        break;
        case 2:
            pic.innerHTML = '<img src="./images/TKU2.png" style="width: 100%; height: auto" />'
        break;
        case 3:
            pic.innerHTML = '<img src="./images/TKU3.png" style="width: 100%; height: auto" />'
        break;
        case 4:
            pic.innerHTML = '<img src="./images/TKU4.png" style="width: 100%; height: auto" />'
        break;
        case 5:
            pic.innerHTML = '<img src="./images/TKU5.png" style="width: 100%; height: auto" />'
        break;
    }
}